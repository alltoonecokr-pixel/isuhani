...
import { YOUTUBE_CHANNEL } from "@/data/videos";
      ...
      <div className="max-w-container mx-auto px-6 md:px-12 py-14 md:py-20">
        ...
        <div className="mt-12 md:mt-16 text-center">
          <a
            ...
            className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-herb-700 text-white text-sm font-bold tracking-[-0.01em] hover:bg-herb-800 transition-colors shadow-[0_10px_24px_-12px_rgba(10,74,69,0.6)]"
          >
            <Youtube size={18} aria-hidden />
            유튜브 채널 전체 영상 보기
          </a>
          <div className="mt-3 text-[12px] text-ink-500">
            @isu_hani · 남성역 이수한의원 공식 채널
          </div>
        </div>
      </div>
