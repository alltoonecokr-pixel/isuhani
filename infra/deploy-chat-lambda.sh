...
#
# 전제:
#   1) 임베딩 JSON이 이미 빌드되어 있음 (frontend/src/data/blog/embeddings.json)
...
#
# 사용:
#   AWS_PROFILE=default bash infra/deploy-chat-lambda.sh
#
...
BUCKET="${BUCKET:-isuhani-test04}"          # 임베딩 저장 버킷 (계정별 오버라이드)
EMBED_LOCAL="frontend/src/data/blog/embeddings.json"
...
LAMBDA_DIR="$ROOT_DIR/infra/lambda-chat"
ZIP_PATH="$ROOT_DIR/infra/lambda-chat.zip"
